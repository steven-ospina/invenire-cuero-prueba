<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.master" AutoEventWireup="true" CodeFile="form_detalle_pedidos.aspx.cs" Inherits="form_detalle_pedidos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:invenire_cuero_ConnectionString %>" SelectCommand="SELECT [cod_ped] FROM [tbl_pedidos]"></asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style2">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="id_det_ped" DataSourceID="SqlDataSource3" ForeColor="#333333" GridLines="None" Width="613px">
            ...
            <Columns>
                <asp:BoundField DataField="cod_ped" HeaderText="cod_ped" SortExpression="cod_ped" />
                ...
                <asp:BoundField DataField="id_det_ped" HeaderText="id_det_ped" InsertVisible="False" ReadOnly="True" SortExpression="id_det_ped" />
            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:invenire_cuero_ConnectionString %>" DeleteCommand="DELETE FROM [tbl_detalle_pedidos] WHERE [id_det_ped] = @id_det_ped" InsertCommand="INSERT INTO [tbl_detalle_pedidos] ([cod_ped], [cod_prod], [cant_ped]) VALUES (@cod_ped, @cod_prod, @cant_ped)" SelectCommand="SELECT * FROM [tbl_detalle_pedidos]" UpdateCommand="UPDATE [tbl_detalle_pedidos] SET [cod_ped] = @cod_ped, [cod_prod] = @cod_prod, [cant_ped] = @cant_ped WHERE [id_det_ped] = @id_det_ped">
            <DeleteParameters>
